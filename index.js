...
const component1 = 
    ...
    <header>
        <nav class="navbar navbar-dark bg-dark fixed-top">
            <div class="container-fluid">
                ...
                <a class="navbar-brand navFont" href="./index.html">ORQUESTA DI PASQUALE</a>                
    ...
    <footer class="py-3 my-4">
        <ul class="nav justify-content-center border-bottom pb-3 mb-3">
            <li class="nav-item">
                <a href="https://api.whatsapp.com/send/?phone=5491140333125"><i class="fa-brands fa-whatsapp"></i></a>
            </li>
            <li class="nav-item">
                <a href="https://www.facebook.com/Orquesta-T%C3%ADpica-Di-Pasquale-108168401875322"><i class="fa-brands fa-facebook-f"></i></a>
            </li>
            <li class="nav-item">
                <a href="https://www.instagram.com/orquestatipicadipasquale/"><i class="fa-brands fa-instagram"></i></a>
            </li>
            <li class="nav-item">
                <a href="https://www.youtube.com/channel/UCBNVVmwPhj9Bdr9k2AiEE3w"><i class="fa-brands fa-youtube"></i></a>
            </li>
        </ul>
